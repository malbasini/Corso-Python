import math
#QUESTO E' UN PICCOLO PROGRAMMA A SCOPO DIDATTICO CHE ILLUSTRA
#L'EREDITARIETA' MULTIPLA. IN UN PROGRAMMA REALE NON SERVONO TRE
#CLASSI PER GESTIRE SEMPLICI OPERAZIONI MATEMATICHE.
class a(object):
